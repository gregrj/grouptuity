...
class TabLayoutMediator(
    ...
    private var onTabSelectedReviewer: ((TabLayout.Tab) -> Boolean)? = null
    ...
    constructor(tabLayout: TabLayout, viewPager: ViewPager2, tabConfigurationStrategy: TabConfigurationStrategy): this(tabLayout, viewPager, true, tabConfigurationStrategy)

    constructor(tabLayout: TabLayout, viewPager: ViewPager2, autoRefresh: Boolean, tabConfigurationStrategy: TabConfigurationStrategy):
    ...
    fun setOnTabSelectedReviewer(reviewer: (TabLayout.Tab) -> Boolean) { onTabSelectedReviewer = reviewer }
     ...
     */
    private class TabLayoutOnPageChangeCallback constructor(tabLayout: TabLayout): OnPageChangeCallback() {
        ...
        override fun onPageSelected(position: Int) {
            ...
            if (tabLayout != null && tabLayout.selectedTabPosition != position && position < tabLayout.tabCount) {
                ...
                val updateIndicator = (scrollState == ViewPager2.SCROLL_STATE_IDLE || (scrollState == ViewPager2.SCROLL_STATE_SETTLING && previousScrollState == ViewPager2.SCROLL_STATE_IDLE))
     ...
     */
    private inner class ViewPagerOnTabSelectedListener constructor(private val viewPager: ViewPager2, private val smoothScroll: Boolean): OnTabSelectedListener {
        override fun onTabSelected(tab: TabLayout.Tab) {
            onTabSelectedReviewer?.apply {
                if(!this(tab)) {
                    return
                }
            }
    ...
    inner class PagerAdapterObserver: AdapterDataObserver() {
